...
- 2026-09-18 — scheduled maintenance run: resolved security item "best-roast-lists.astro renders singlePage.content via set:html without calling sanitizeContent" (section 6)
